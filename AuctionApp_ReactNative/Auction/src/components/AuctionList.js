...
class AuctionList extends Component{
  ...
  static defaultProps = {
    auctionList: Object(),
    toNavigate: "AuctionDetail"
  };

  renderAuctionItem({ item, index, separators }) {
    console.log(item)
    return (
      <AuctionItem
        item={item}
    ...
    return (
      <View>
        <FlatList
          ...
          renderItem={this.renderAuctionItem.bind(this)}
...
export default withNavigationFocus(AuctionList);
